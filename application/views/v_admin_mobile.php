	...
	<header> 
		<img id="set" class="icon lefticon" id="world" src="<?php echo base_url();?>images/set.png">
		<img id="list" class="icon lefticon" id="world" src="<?php echo base_url();?>images/list.png">
