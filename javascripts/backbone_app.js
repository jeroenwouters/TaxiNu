...
var Bestelling = Backbone.Model.extend({
	...
	showmodal: function() {
		var bestellingRevealView = new BestellingRevealView({
			model: this
		});
		$('#checkmodal').reveal();
...
var BestellingListView = Backbone.View.extend({
	...
	addOne: function(bestelling) {
		...
		var bestellingView = new BestellingView({
			model: bestelling
		});
...
var TaxiView = Backbone.View.extend({
	...
	settings: function() {
		console.log(this.model);
		var taxisettingsView = new TaxisettingsView({
			model: this.model
		});
...
var AdminPanel = new(Backbone.Router.extend({
	...
	initialize: function() {
		...
		this.bestellingListView = new BestellingListView({
			collection: this.bestellingList
		});
		this.taxiList = new TaxiList();
		this.taxiListView = new TaxiListView({
			collection: this.taxiList
		});
		this.user = new User();
